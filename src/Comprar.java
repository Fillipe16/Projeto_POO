...
public class Comprar extends javax.swing.JFrame {
    ...
    String horario="";
    Sessao s;
    public void recebendo(ArrayList<Sessao> salas,String sessao,String horario,String sala,Sessao s){
        this.sessoes=salas;
        this.sessao=sessao;
        this.sala=sala;
        ...
        Sbanco=new SessaoDAO();
        Ibanco=new IngressoDAO();
        horario=Sessao.dados(sessao).get(1);
        sala=Sessao.dados(sessao).get(0);
        cads=Ibanco.cadeirasOcupadas(sala,horario);
        Sbanco.analisarCadeira(cads.toString(), sala, horario);
    ...
    public void atualizandoCadeiras(){
        System.out.println("SESSAO:"+s);
        System.out.println("Sala:"+sala);
        System.out.println("HR:"+horario);
        System.out.println("CADEIRAS OCUPADAS:"+cadeirasSessao);
        if(cadeirasSessao.contains("cad1,") || cadeirasSessao.contains("cad1]")){
            cad1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(0).setEstado(0);
        }
        else{
            cad1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(0).setEstado(1);
        }
      
        if(cadeirasSessao.contains("cad2,") ||cadeirasSessao.contains("cad2]")){
            cad2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(1).setEstado(0);
        }
        else{
            cad2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(1).setEstado(1);
        }
        if(cadeirasSessao.contains("cad3") && s.getCadeiras().get(2).getEstado()==0){
         ...
         if(cadeirasSessao.contains("cad4")){
            cad4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(3).setEstado(0);
        }
        else{
            cad4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(3).setEstado(1);
        }if(cadeirasSessao.contains("cad5")){
            cad5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(4).setEstado(0);
        }
        else{
            cad5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(4).setEstado(1);
        }if(cadeirasSessao.contains("cad6")){
            cad6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(5).setEstado(0);
        }
        else{
            cad6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(5).setEstado(1);
        }if(cadeirasSessao.contains("cad7")){
            cad7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(6).setEstado(0);
        }
        else{
            cad7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(6).setEstado(1);
        }if(cadeirasSessao.contains("cad8")){
            cad8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(7).setEstado(0);
        }
        else{
            cad8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(7).setEstado(1);
        }if(cadeirasSessao.contains("cad9")){
            cad9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(8).setEstado(0);
        }
        else{
            cad9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(8).setEstado(1);
        }if(cadeirasSessao.contains("cad10")){
            cad10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(9).setEstado(0);
        }
        else{
            cad10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(9).setEstado(1);
        }if(cadeirasSessao.contains("cad11")){
            cad11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(10).setEstado(0);
        }
        else{
            cad11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(10).setEstado(1);
        }if(cadeirasSessao.contains("cad12")){
            cad12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(11).setEstado(0);
        }
        else{
            cad12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(11).setEstado(1);
        }if(cadeirasSessao.contains("cad13")){
            cad13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(12).setEstado(0);
        }
        else{
            cad13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(12).setEstado(1);
        }if(cadeirasSessao.contains("cad14")){
            cad14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(13).setEstado(0);
        }
        else{
            cad14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(13).setEstado(1);
        }if(cadeirasSessao.contains("cad15")){
            cad15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(14).setEstado(0);
        }
        else{
            cad15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(14).setEstado(1);
        }if(cadeirasSessao.contains("cad16")){
            cad16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(15).setEstado(0);
        }
        else{
            cad16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(15).setEstado(1);
        }if(cadeirasSessao.contains("cad17")){
            cad17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(16).setEstado(0);
        }
        else{
            cad17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(16).setEstado(1);
        }if(cadeirasSessao.contains("cad18")){
            cad18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(17).setEstado(0);
        }
        else{
            cad18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(17).setEstado(1);
        }if(cadeirasSessao.contains("cad19")){
            cad19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(18).setEstado(0);
        }
        else{
            cad19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(18).setEstado(1);
        }if(cadeirasSessao.contains("cad20")){
            cad20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(19).setEstado(0);
        }
        else{
            cad20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(19).setEstado(1);
        }if(cadeirasSessao.contains("cad21")){
            cad21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(20).setEstado(0);
        }
        else{
            cad21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(20).setEstado(1);
        }if(cadeirasSessao.contains("cad22")){
            cad22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(21).setEstado(0);
        }
        else{
            cad22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(21).setEstado(1);
        }if(cadeirasSessao.contains("cad23")){
            cad23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(22).setEstado(0);
        }
        else{
            cad23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(22).setEstado(1);
        }if(cadeirasSessao.contains("cad24")){
            cad24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(23).setEstado(0);
        }
        else{
            cad24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(23).setEstado(1);
        }if(cadeirasSessao.contains("cad25")){
            cad25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(24).setEstado(0);
        }
        else{
            cad25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
            s.getCadeiras().get(24).setEstado(1);
        }if(cadeirasSessao.contains("cad26")){
            cad26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ocupada.png")));   
            s.getCadeiras().get(25).setEstado(0);
        }
        else{
            cad26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));   
    ...
    private void initComponents() {
        ...
        jLabelbackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background 4.png"))); // NOI18N
        ...
        cad1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        cad26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png"))); // NOI18N
        ...
        jconfirmaicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/validar.png"))); // NOI18N
    ...
    private void cad1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad1ActionPerformed
        ...
        for(int i=0;i<sessao.length();i++){
            ...
            else if(contador==1 && sessao.charAt(i+2)=='|'){
                salaS+=sessao.charAt(i);
            }
            if(contador==2){
                break;
            }   
        }
        int sala=Integer.parseInt(salaS)-1;
        //int aux=sessoes.get(sala).verEstado("cad1");
        int aux=s.getCadeiras().get(0).getEstado();
        System.out.println("EESSTTAADDOO:"+aux);
        if(s!=null){
            System.out.println("EESSATTTDOO2:"+s.getCadeiras().get(0).getEstado());
        }
        if(aux==1){
            cad1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad1");
        }
        else if(aux==-1){
            cad1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad4ActionPerformed
        ...
        if(aux==1){
            cad4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad4");
        }
        else if(aux==-1){
            cad4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad2ActionPerformed
        ...
        if(aux==1){
            cad2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad2");
        }
        else if(aux==-1){
            cad2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad6ActionPerformed
        ...
        if(aux==1){
            cad6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad6");
        }
        else if(aux==-1){
            cad6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad7ActionPerformed
        ...
        if(aux==1){
            cad7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad7");
        }
        else if(aux==-1){
            cad7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad5ActionPerformed
        ...
        if(aux==1){
            cad5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad5");
        }
        else if(aux==-1){
            cad5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad8ActionPerformed
        ...
        if(aux==1){
            cad8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad8");
        }
        else if(aux==-1){
            cad8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad9ActionPerformed
        ...
        if(aux==1){
            cad9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad9");
        }
        else if(aux==-1){
            cad9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad11ActionPerformed
        ...
        if(aux==1){
            cad11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad11");
        }
        else if(aux==-1){
            cad11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad12ActionPerformed
        ...
        if(aux==1){
            cad12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad12");
        }
        else if(aux==-1){
            cad12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad14ActionPerformed
        ...
        if(aux==1){
            cad14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad14");
        }
        else if(aux==-1){
            cad14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad15ActionPerformed
        ...
        if(aux==1){
            cad15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad15");
        }
        else if(aux==-1){
            cad15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad10ActionPerformed
        ...
        if(aux==1){
            cad10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad10");
        }
        else if(aux==-1){
            cad10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad13ActionPerformed
        ...
        if(aux==1){
            cad13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad13");
        }
        else if(aux==-1){
            cad13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad16ActionPerformed
        ...
        if(aux==1){
            cad16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad16");
        }
        else if(aux==-1){
            cad16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad17ActionPerformed
        ...
        if(aux==1){
            cad17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad17");
        }
        else if(aux==-1){
            cad17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad18ActionPerformed
        ...
        if(aux==1){
            cad18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad18");
        }
        else if(aux==-1){
            cad18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad3ActionPerformed
        ...
        if(aux==1){
            cad3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad3");
        }
        else if(aux==-1){
            cad3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad19ActionPerformed
        ...
        if(aux==1){
            cad19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad19");
        }
        else if(aux==-1){
            cad19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad20ActionPerformed
        ...
        if(aux==1){
            cad20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad20");
        }
        else if(aux==-1){
            cad20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad21ActionPerformed
        ...
        if(aux==1){
            cad21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad21");
        }
        else if(aux==-1){
            cad21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad22ActionPerformed
        ...
        if(aux==1){
            cad22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad22");
        }
        else if(aux==-1){
            cad22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad23ActionPerformed
        ...
        if(aux==1){
            cad23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad23");
        }
        else if(aux==-1){
            cad23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad24ActionPerformed
        ...
        if(aux==1){
            cad24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad24");
        }
        else if(aux==-1){
            cad24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad25ActionPerformed
        ...
        if(aux==1){
            cad25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad25");
        }
        else if(aux==-1){
            cad25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void cad26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cad26ActionPerformed
        ...
        if(aux==1){
            cad26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/selecionada.png")));
            s.selecionar("cad26");
        }
        else if(aux==-1){
            cad26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/livre.png")));
    ...
    private void jconfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jconfirmaActionPerformed
        ...
        for(int i=0;i<sessao.length();i++){
            ...
            if(contador<1 && i>5){
                filme+=sessao.charAt(i);
            }
            if(contador==1 && Character.isDigit(sessao.charAt(i))){
                    sala+=sessao.charAt(i);
            }
            if(contador==2){
                break;
            }   
        ...
        this.sala=Sessao.dados(sessao).get(0);
        this.horario=Sessao.dados(sessao).get(1);
        for(int i=0;i<s.getCadeiras().size();i++){
            System.out.println("Cadeira:"+s.getCadeiras().get(i).getNome()+",Estado:"+s.getCadeiras().get(i).getEstado());
        }
        horario=Sessao.dados(sessao).get(1);
        sala=Sessao.dados(sessao).get(0);
        cads=Ibanco.cadeirasOcupadas(sala,horario);
    ...
    private void jcancelaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcancelaActionPerformed
        ...
        for(int i=0;i<sessoes.size();i++){
            for(int aux=0;aux<sessoes.get(i).getCadeiras().size();aux++){
                if(sessoes.get(i).getCadeiras().get(aux).getEstado()==-1){
                    //cancelar(salas.get(i).getCadeiras().get(aux).getNome());
                }
            }
        }
        Comprar.this.dispose(); 
